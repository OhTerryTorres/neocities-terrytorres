...
<html>
  ...
  <head>
    <meta charset="utf-8">
    <link rel="stylesheet" href="http://terry-torres.com/yatta/mobile.css?<?php echo time(); ?>">
...
<div class="jumbotron">
      <div class="container">
	<center>
        <h1 id="yatta">Yatta, the Achievement Tracker</h1>
        <p id ="blurb">Just what you need to game-ify your next field trip, reception, scavenger hunt, bachelor party - any soiree you can think of!</p>
    ...
    <div class="learn-more">
        <div class="container">
		    ...
		    <img class="max" src="images/yatta_3_achieve.png">
                ...
                <div id="title" class="col-xs-12 col-lg-6">
                    <h3>ACHIEVE</h3>
		    <p>With the <b>Yatta</b> app, guests can participate in friendly competition, share their feats online, and capture the good times from many points of view.</p>
...
<center>
		...
		<p>Tell us your story, get a quote, and see what can be done.</p>
		</br>
